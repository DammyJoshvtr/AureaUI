  ...
  return (
    <View className="flex-1 bg-primary">
      ...
      <Image
        ...
        className="absolute h-full w-full scale-[1.09] -right-5 top-20"
        resizeMode="cover"
      />
      ...
      <View className="flex w-full h-full items-center justify-end">
        ...
        <View className="h-[400px] w-full">
          ...
          <View className="flex justify-end items-center px-6">
            ...
            <Text className="font-home-bold text-center text-white italic text-[3.5rem] leading-[3.5rem] font-bold mb-9">
              Embrace Your Glow,{"\n"}
              <Text className="font-home-regular not-italic font-normal text-white text-[3rem]">
                One day at a time.
              </Text>
            </Text>

            <Text className="text-white text-center text-2xl font-home-regular">
              Auréa helps you stay on track with routines
            </Text>
            <Text className="text-white text-center text-2xl font-home-regular mb-9">
              that nurture your skin and confidence.
            </Text>
            ...
            <Link href="/Signup" asChild>
              <TouchableOpacity
                ...
                // onPress={"/signup"}
              >
                <Text className="text-center font-home-semibold font-semibold text-2xl text-gray-500">
                  Get Started
                </Text>
              </TouchableOpacity>
            </Link>
